package com.bottlecast.app.feature.getmessage.components
...
fun UnbottledMessageCard(
    ...
    val imageFlag: ImageVector = if (isReported) Icons.Filled.Flag else Icons.Outlined.Flag
